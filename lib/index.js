                ...
                for (const message of result.messages) {
                    ...
                    if (indexedModifiedLines[message.line]) {
                        ...
                        if (message.fix) {
                            ...
                            const response = yield octokit.rest.pulls.createReviewComment(Object.assign(Object.assign({ owner,
                                repo }, reviewSuggestion), { body: `**${message.message}** [${message.ruleId}](${(_a = rule === null || rule === void 0 ? void 0 : rule.docs) === null || _a === void 0 ? void 0 : _a.url})\n\nFix available:\n\n` +
                                    reviewSuggestion.body, pull_number: pullRequestNumber, commit_id: headSha, path: file.filename }));
                            ...
                            const response = yield octokit.rest.pulls.createReviewComment(Object.assign(Object.assign({ owner,
                                repo }, reviewSuggestions), { body: `**${message.message}** [${message.ruleId}](${(_b = rule === null || rule === void 0 ? void 0 : rule.docs) === null || _b === void 0 ? void 0 : _b.url})\n\nSuggestion(s) available:\n\n` +
                                    (reviewSuggestions === null || reviewSuggestions === void 0 ? void 0 : reviewSuggestions.body), pull_number: pullRequestNumber, commit_id: headSha, path: file.filename }));
                            (0, core_1.info)(`    Commented`);
                        }
                        else {
